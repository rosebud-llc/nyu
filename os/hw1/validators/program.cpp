...
//static
unsigned int ProgramValidator::is_valid_token_count(char* p_token)
{
	...
	//TODO this needs to be fixed - do you check number of instructions in the line or the total number of instructions in the entire series of modules?
	// in which case you would need to hold/carry that count around to inspect
	static const unsigned int maxTokenCount = 512;
	if (!ProgramValidator::is_valid_number_size(p_token, maxTokenCount))
	{
