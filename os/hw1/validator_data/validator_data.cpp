		...
		ModuleData& moduleData)
{
	...
	else if (validator->validatorType == 1)
	{
		//TODO This is only necessary on passTwo. you may not need the OR IF check above, just iterate over all three if/else if possibilities
		moduleData.clear_symbols_from_use_list();
	}
